...
CascadeGenerator::LevelScheme getScheme(G4String FilePath){
    CascadeGenerator::LevelScheme scheme(0);
    std::ifstream myfile;
...
CascadeMessenger::CascadeMessenger(CascadeGenerator* PriGen):fPriGen(PriGen){
